...
dt["Date de naissance"] = pd.to_datetime(dt["Date de naissance"], format="%d/%m/%Y", errors="raise")
dt["Date de naissance"] = dt["Date de naissance"].dt.date
dt["Date de facturation THEORIQUE ST 1"] = pd.to_datetime(dt["Date de facturation THEORIQUE ST 1"], format="%d/%m/%Y", errors="raise")
dt["Date de facturation THEORIQUE ST 1"] = dt["Date de facturation THEORIQUE ST 1"].dt.date
dt["Date de facturation ST 2 (calculée sur l'envoi de la série)"] = pd.to_datetime(dt["Date de facturation ST 2 (calculée sur l'envoi de la série)"], format="%d/%m/%Y", errors="raise")
...
dt["Date de facturation ST3 (calculée sur l'envoi de la série)"] = pd.to_datetime(dt["Date de facturation ST3 (calculée sur l'envoi de la série)"], format="%d/%m/%Y", errors="raise")
...
dt["Date de facturation AT (calculée sur l'envoi de la série)"] = pd.to_datetime(dt["Date de facturation AT (calculée sur l'envoi de la série)"], format="%d/%m/%Y", errors="raise")
